...
class ParserModel(nn.Module):
    ...
    def embedding_lookup(self, t):
        ...
        batch_size = t.size()[0]
        x = self.pretrained_embeddings(t).view(batch_size, self.n_features * self.embed_size)
    ...
    def forward(self, t):
        ...
        word_embeddings = self.embedding_lookup(t)
        ReLU = nn.ReLU()
        hidden_layer = ReLU(self.embed_to_hidden(word_embeddings))
